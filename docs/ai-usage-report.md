...
- **Scalling:** AI generated clamp() values are unrealistic and needs re-scaling many times to get the right size.

## 3- Responsive Use & Modificatoins:
